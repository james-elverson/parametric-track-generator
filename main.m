track_image = input("Enter track image file (name.png):", "s");
track_name = input("Enter track name:", "s");
track = make_track(track_image, 1.0, track_name);


function track = make_track(imgFile, ds_target, saveName)
